        ...
        <div class="col-md-6 themed-grid-col text-le">
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="title" value="{{ old('name') }}" autofocus>
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input name="slug" type="text" class="form-control @error('slug') is-invalid @enderror" id="title" value="{{ old('slug') }}">
                    @error('slug')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
